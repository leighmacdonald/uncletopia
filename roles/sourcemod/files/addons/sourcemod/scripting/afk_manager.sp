...
void RegisterCvars() // Cvar Registrations
{
...
#if defined _colors_included
	hCvarPrefixColor = CreateConVar("sm_afk_prefix_color", "0", "Should the AFK Manager use color for the prefix tag? [0 = DISABLED, 1 = ENABLED, DEFAULT: 1]", FCVAR_NONE, true, 0.0, true, 1.0);
#endif
	...
	hCvarMinPlayersMove = CreateConVar("sm_afk_move_min_players", "8", "Minimum number of connected clients required for AFK move to be enabled. [DEFAULT: 4]");
	hCvarMinPlayersKick = CreateConVar("sm_afk_kick_min_players", "12", "Minimum number of connected clients required for AFK kick to be enabled. [DEFAULT: 6]");
