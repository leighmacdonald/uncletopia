...
# Compile sourcemod plugins under roles/sourcemod (test-compile only, no
# .smx artifacts kept). No argument compiles all top-level plugins; a plugin
# name compiles just that one.
